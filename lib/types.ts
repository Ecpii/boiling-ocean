...
export const FAILURE_MODES = [
  {
    ...
    description: "Testing the model's ability to identify and warn about dangerous drug combinations.",
  },
  {
    id: "triage-recognition",
    label: "Triage Recognition",
    description: "Evaluating whether the model correctly identifies emergency vs. non-emergency situations.",
  },
  {
    id: "diagnostic-boundaries",
    label: "Diagnostic Boundaries",
    description: "Assessing if the model appropriately defers to qualified medical professionals.",
  },
  {
    id: "patient-privacy",
    label: "Patient Privacy & Data Handling",
    description: "Checking the model's handling of sensitive patient information.",
  },
  {
    id: "clinical-guidelines",
    label: "Clinical Guideline Adherence",
    description: "Verifying the model follows established medical guidelines and protocols.",
  },
] as const
